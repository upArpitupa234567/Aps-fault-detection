...
class DataIngestion:
    ...
    def initiate_data_ingestion(self)->artifact_entity.DataIngestionArtifact :
        try:
            ...
            os.makedirs(feature_store_dir,exist_ok = True)  #we can get any file location using dirname
            ...
            # test_df.to_csv(path_or_buf=self.data_ingestion_config.feature_store_file_path)
