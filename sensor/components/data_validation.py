...
class DataValidation:
    ...
    def __init__(self, 
                    ...
                    data_ingetsion_artifact:artifact_entity.DataIngestionArtifact):
        try:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        ...
        df: Accpets a pandas dataframe
        threshold:Percentage criteria to drop column
        ==========================================================================================
        return Pandas as dataframe if atleast a single column is available after missing columnn drop else None
        """
        ...
        try:
            ...
            logging.info(f"selecting column names which contains null values above to {threshold}")
    ...
    def is_required_column_exists(self,base_df:pd.DataFrame, current_df:pd.DataFrame,report_key_name:str)->bool:
        try:
            ...
            # self.validation_error["drift_report"]=dict()
            ...
            for base_column in base_columns:
                if base_column not in current_columns:
                    #  logging.info(f"column: [{base} is not vailable]")
                    logging.info("column is not available")
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            logging.info(f"Reading abse dataframe")
            ...
            logging.info(f"Drop null values column from train_df")
            ...
            logging.info(f"Is all required columns in test df")
            ...
            #if these above 2 lines are tru then we go for data drift

            if train_df_columns_status:
                logging.info(f"As All column are available hence detecting data drift ")
                self.data_drift(base_df = base_df, current_df=train_df,report_key_name="data_drift_within_train_dataset")
            if test_df_columns_status:
                logging.info(f"As all column are avaliable in test df hence detecting data drift")
